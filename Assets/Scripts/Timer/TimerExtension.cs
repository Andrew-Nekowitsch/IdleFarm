...
using UnityEngine;
    ...
    public static class TimerExtensions
    {
        ...
        public static TimerClass AttachTimer(this MonoBehaviour behaviour, float duration, Action onComplete,
            Action<float> onUpdate = null, bool isLooped = false, bool useRealTime = false)
        {
            return TimerClass.Register(duration, onComplete, onUpdate, isLooped, useRealTime, behaviour);
        }
    }